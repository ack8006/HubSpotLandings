...
@implementation HubSpotLandingsViewController
...
-(CSVBrain *) csv
{
    if (!csv) csv = [[CSVBrain alloc] init];
    return csv;
}

- (void)loadView 
{    
    self.pictures = [self.csv parseCSVFile];
...
- (CGSize)imageSizeAtIndex:(NSUInteger)index {
    ...
    UIImage *image = [self.pictures objectAtIndex:index];
